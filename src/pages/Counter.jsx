...
export default function Counter() {
    ...
    return (
        <section className='paddingHorizontal paddingVertical flex items-start justify-center bg-black text-white h-screen'>
            ...
            <div className='mt-10 paddingVertical paddingHorizontal flex items-center justify-center lg:w-full w-[80%]'>
                <div className='flex flex-col items-center justify-between border border-black p-5 bg-white text-black rounded-lg lg:w-[30%] w-full gap-5'>
